                            ...
                            if (execucoes && Array.isArray(execucoes) && execucoes.length > 0) {
                                ...
                                execucoes.forEach((execucao) => {
                                    ...
                                    mappedData.push({
                                        ...
                                        inicio_real: dateEnToPtWithHour(inicio_execucao) || 'N/D', // Usando inicio_execucao
                                        fim_real: dateEnToPtWithHour(fim_execucao) || 'N/D', // Usando fim_execucao
